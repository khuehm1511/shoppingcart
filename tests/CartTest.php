...
namespace Khuehm1511\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Khuehm1511\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Khuehm1511\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Khuehm1511\Shoppingcart\ShoppingcartServiceProvider;
use Khuehm1511\Tests\Shoppingcart\Fixtures\ProductModel;
use Khuehm1511\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Khuehm1511\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Khuehm1511\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Khuehm1511\Shoppingcart\Exceptions\CartAlreadyStoredException
